...
import {
  CustomConnectWallet,
  CustomConnectWallet2,
} from '@/components/web3/ConnectWallet';
...
export const Stake: FC<ActionProp> = ({ tokenAddress }) => {
  ...
  const [allowance, allow] = useERC20ApproveCallback(
    true,
    '0x31b0A3e4bF7f55069Faa13b2d8EEAAF96F3ee5b7',
    BigNumber.from(100)
  );
  ...
  return (
    <>
      <div className='p-0 sm:p-5 md:p-10'>
        ...
        <CustomConnectWallet2 className='w-full justify-center py-5'>
          Add supply
        </CustomConnectWallet2>
